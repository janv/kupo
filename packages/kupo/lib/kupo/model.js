 ...
 */
CommonInstancePrototype.id = function() {
...
ClassPrototype.validatesNumericalityOf = function(prop) {
  return function(){
...
exports.Model.belongs_to_many = function(model, options) {
 ...
 * it with accessors for the association.
 */
exports.Model.has_one = function(model, options) {
  // this gets called in the context of the Instance Prototype, creating the
  // accessor functions
  return function(assocName) {
    var ownKey = this.model.name + "_id"
